...
public class ProdutoService {
	...
	public ProdutoVO findById(Long id) {
		/*Procura na base o produto com o ID passado no parametro,
		 *caso não encontrado lança a Exception criada */
	...
	public ProdutoVO update(ProdutoVO produtoVO) {
		//SALVA O RETORNO DO findById E CASO ESTEJA VASIO ELE RETORNA UMA EXCEPTION
	...
	public void delete(long id) {
		//PRIMEIRO ELE PROCURA O PRODUTO COM O ID PASSADO, CASO NÃO ENCONTRADO RETORNA UMA EXCEPTION
		//OUTRA MANEIRA DE SE FAZER A VERIFICAÇÃO VIDEO METODO "UPDATE"
